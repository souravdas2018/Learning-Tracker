...
- 🤖 **AI Learning Coach** - Personalised progress insights generated by AI
- 💬 **AI Study Assistant** - Per-module Q&A chatbot with conversation history
- 🧠 **AI Quiz Generator** - Auto-generated 5-question multiple-choice quizzes per module
- 🎯 **AI Course Recommendations** - Smart suggestions for unenrolled courses
- 🗨️ **AI Dashboard Chat** - Floating general-purpose learning assistant with platform context
...
- 🤖 **AI Platform Summary** - Executive health summary of the platform
- ⚠️ **AI Engagement Risk Analysis** - Identifies at-risk engagement areas with actionable recommendations
- 📋 **AI Content Gap Analysis** - Suggests new course topics based on enrollment patterns
- ✍️ **AI Course Description Generator** - One-click AI-written course descriptions
- 🗨️ **AI Admin Chat** - Floating admin assistant aware of live platform metrics
...
- **Google Gemini API** (`gemini-1.5-flash`) - Primary AI provider (free tier, 1500 req/day)
- **Groq API** (`llama-3.3-70b-versatile`) - Fallback AI provider (free tier)
