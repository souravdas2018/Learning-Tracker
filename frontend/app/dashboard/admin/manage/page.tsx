...
import { adminAPI, courseAPI, aiAPI } from '@/services/api';
...
export default function AdminManagePage() {
  ...
  const handleGenerateDescription = async () => {
    ...
    try {
      ...
      const res = await aiAPI.generateCourseDescription(courseForm.title.trim());
      setCourseForm(f => ({ ...f, description: res.data.description }));
                        ...
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <button type="button" onClick={handleGenerateDescription} disabled={generatingDesc}
                            ...
                            {generatingDesc
                              ...
                              : <><svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3" /></svg>Generate with AI</>
                            }
                          </button>
                        </div>
                        <textarea
